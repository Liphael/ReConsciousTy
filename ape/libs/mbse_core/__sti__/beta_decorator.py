...
class MBSE_Warning(DeprecationWarning):
...
def suppress_langchain_beta_warning() -> Generator[None, None, None]:
    ...
    with warnings.catch_warnings():
        warnings.simplefilter("ignore", MBSE_Warning)
        yield
...
def warn_beta(
    *,
    ...
    warning = MBSE_Warning(message)
    warnings.warn(warning, category=MBSE_Warning, stacklevel=4)
